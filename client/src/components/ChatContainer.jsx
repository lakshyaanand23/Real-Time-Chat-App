...
const ChatContainer = () => {
  ...
  const { selectedUser, setSelectedUser, sendMessage, getMessages, messages } = useContext(ChatContext);
  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg '>
      {/* Header  */}
      <div className='flex items-center gap-3 py-3 mx-4 border-b border-stone-500 w-130'>
      ...
      <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
        <div className='flex-1 flex items-center bg-gray-100/12 px-3 rounded-full'>
          ...
          <label htmlFor="image">
            <img src={assets.gallery_icon} alt="" className='w-5 mr2\
             cursor-pointer' />
          </label>
        </div>
    ...
    <div className='flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden w-130'>
